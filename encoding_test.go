...
func TestBytesToUint16(t *testing.T) {
	...
	result = binary.BigEndian.Uint16([]byte{0x43, 0x21})
	if result != 0x4321 {
		t.Errorf("expected 0x4321, got 0x%04x", result)
	}

	result = binary.LittleEndian.Uint16([]byte{0x43, 0x21})
	if result != 0x2143 {
...
func TestUint32ToBytes(t *testing.T) {
	...
	out = uint32ToBytes(binary.BigEndian, HIGH_WORD_FIRST, 0x87654321)
	if len(out) != 4 {
	...
	out = uint32ToBytes(binary.BigEndian, LOW_WORD_FIRST, 0x87654321)
	if len(out) != 4 {
		t.Errorf("expected 4 bytes, got %v", len(out))
	}
	...
	out = uint32ToBytes(binary.LittleEndian, LOW_WORD_FIRST, 0x87654321)
	if len(out) != 4 {
		t.Errorf("expected 4 bytes, got %v", len(out))
	}
	...
	out = uint32ToBytes(binary.LittleEndian, HIGH_WORD_FIRST, 0x87654321)
	if len(out) != 4 {
		t.Errorf("expected 4 bytes, got %v", len(out))
	}
...
func TestFloat32ToBytes(t *testing.T) {
	...
	out = float32ToBytes(binary.BigEndian, HIGH_WORD_FIRST, 1.234)
	if len(out) != 4 {
		t.Errorf("expected 4 bytes, got %v", len(out))
	}
	...
	out = float32ToBytes(binary.BigEndian, LOW_WORD_FIRST, 1.234)
	if len(out) != 4 {
		t.Errorf("expected 4 bytes, got %v", len(out))
	}
	...
	out = float32ToBytes(binary.LittleEndian, LOW_WORD_FIRST, 1.234)
	if len(out) != 4 {
		t.Errorf("expected 4 bytes, got %v", len(out))
	}
	...
	out = float32ToBytes(binary.LittleEndian, HIGH_WORD_FIRST, 1.234)
	if len(out) != 4 {
		t.Errorf("expected 4 bytes, got %v", len(out))
	}
...
func TestUint64ToBytes(t *testing.T) {
	...
	out = uint64ToBytes(binary.BigEndian, HIGH_WORD_FIRST, 0x0fedcba987654321)
	if len(out) != 8 {
	...
	out = uint64ToBytes(binary.BigEndian, LOW_WORD_FIRST, 0x0fedcba987654321)
	if len(out) != 8 {
		t.Errorf("expected 8 bytes, got %v", len(out))
	}
	...
	out = uint64ToBytes(binary.LittleEndian, LOW_WORD_FIRST, 0x0fedcba987654321)
	if len(out) != 8 {
		t.Errorf("expected 8 bytes, got %v", len(out))
	}
	...
	out = uint64ToBytes(binary.LittleEndian, HIGH_WORD_FIRST, 0x0fedcba987654321)
	if len(out) != 8 {
		t.Errorf("expected 8 bytes, got %v", len(out))
	}
...
func TestFloat64ToBytes(t *testing.T) {
	...
	out = float64ToBytes(binary.BigEndian, HIGH_WORD_FIRST, 1.2345678)
	if len(out) != 8 {
		t.Errorf("expected 8 bytes, got %v", len(out))
	}
	...
	out = float64ToBytes(binary.BigEndian, LOW_WORD_FIRST, 1.2345678)
	if len(out) != 8 {
		t.Errorf("expected 8 bytes, got %v", len(out))
	}
	...
	out = float64ToBytes(binary.LittleEndian, LOW_WORD_FIRST, 1.2345678)
	if len(out) != 8 {
		t.Errorf("expected 8 bytes, got %v", len(out))
	}
	...
	out = float64ToBytes(binary.LittleEndian, HIGH_WORD_FIRST, 1.2345678)
	if len(out) != 8 {
		t.Errorf("expected 8 bytes, got %v", len(out))
	}
